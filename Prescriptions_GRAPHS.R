...
plot(Sum_Usage_Prescriptions_Ordered_6_21$time, Sum_Usage_Prescriptions_Ordered_6_21$precrip_ordered,
     ...
     lwd="2",
     main="NHS App Precriptions Ordered January 2019-May 2021",
     type="l",
     xaxt="n",
     panel.first=grid())
...
text( 15, 540000, "1st lockdown", col="black", cex=1.3, pos=4 )
...
plot(Sum_Usage_Prescriptions_Ordered_6_21$time, Sum_Usage_Prescriptions_Ordered_6_21$precrip_ordered,
     ...
     ylab="Precriptions Ordered",
     xlab="Month",
     main="NHS App Precriptions Ordered ITS",
     col="red",
     bty="o",
     xaxt="n",
     panel.first=grid())

rect(15.5,0,30,540000,col=grey(0.9),border=F)
...
text( 15.5, 540000, "1st lockdown", col="black", cex=1.3, pos=4 )
