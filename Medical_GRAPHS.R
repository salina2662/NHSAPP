...
plot(Sum_Usage_MedicalRecords_views_6_21$time, Sum_Usage_MedicalRecords_views_6_21$med_views,
     ...
     lwd="2",
     main="NHS App Medical Records Viewed January 2019-May 2021",
     type="l",
     xaxt="n",
     panel.first=grid())
...
text( 15, 9400000, "1st lockdown", col="black", cex=1.3, pos=4 )
...
plot(Sum_Usage_MedicalRecords_views_6_21$time, Sum_Usage_MedicalRecords_views_6_21$med_views,
     ...
     ylab="Medical Records Viewed",
     xlab="Month",
     main="NHS App Medical Records ITS",
     col="red",
     bty="o",
     xaxt="n",
     panel.first=grid())

rect(15.5,0,30,9400000,col=grey(0.9),border=F)
...
text( 15.5, 9400000, "1st lockdown", col="black", cex=1.3, pos=4 )
